...
export default function ChatScreen({ onNavigate, goBack, params }: ChatScreenProps) {
  ...
  const selectedChat = useMemo(() => 
    conversations.find(c => c.id === (currentConvId || conversationId)) || localConversation, 
    [conversations, currentConvId, conversationId, localConversation]
  );
  ...
  if (!selectedChat) return <View style={styles.container}><ActivityIndicator color="#0058bc" /></View>;
